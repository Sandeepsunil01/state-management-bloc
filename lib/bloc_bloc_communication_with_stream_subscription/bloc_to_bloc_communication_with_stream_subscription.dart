...
class BlocToBlocCommunicationWithStreamSubscription extends StatelessWidget {
  const BlocToBlocCommunicationWithStreamSubscription({super.key});
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: MaterialApp(
        ...
        home: const BlocToBlocCommunicationWithStreamSubscriptionPage(),
      ),
    );
  }
}

class BlocToBlocCommunicationWithStreamSubscriptionPage
    extends StatelessWidget {
  const BlocToBlocCommunicationWithStreamSubscriptionPage({super.key});
